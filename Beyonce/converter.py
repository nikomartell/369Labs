...
input_file = "Beyonce/vbsmeFall24_instructionMem.txt"  # Replace with your input file name
output_file = "instructionMem.mem"  # Replace with your desired output file name
